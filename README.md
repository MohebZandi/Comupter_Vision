...
با توجه به اینکه نوشتن متن فارسی در این محیط ممکن است باعث ایجاد مشکلاتی در خواند متن و یا درج تصاویر گردد می توانید از فایل متنی ورد که در این فولدر وجود دارد استفاده نمایید.
